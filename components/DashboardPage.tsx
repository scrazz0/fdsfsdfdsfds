...
const Wallet = () => {
    ...
    const sendTelegramNotification = httpsCallable(functions, 'sendTelegramNotification');
    ...
    const handleWithdrawal = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const result = await sendTelegramNotification({ amount, address });
            console.log(result);
        ...
        <div className="bg-surface-light dark:bg-surface-dark p-8 rounded-xl shadow-md">
            <form className="space-y-6">
                <div>
                    ...
                    <input type="text" id="name" defaultValue="John Doe" className="mt-1 block w-full px-3 py-2 bg-background-light dark:bg-background-dark border border-gray-300 dark:border-gray-600 rounded-md" />
                </div>
                <div>
                    <label htmlFor="email" className="block text-sm font-medium">Email</label>
                    <input type="email" id="email" defaultValue="john.doe@example.com" disabled className="mt-1 block w-full px-3 py-2 bg-gray-200 dark:bg-gray-700 border rounded-md" />
                </div>
                 <div>
