        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            {!isLogin && (
                 <div>
                    ...
                    <input type="text" id="name" required className="mt-1 block w-full px-4 py-3 bg-background-light dark:bg-background-dark border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-primary focus:border-primary" />
                </div>
            )}
            <div>
                ...
                <input type="email" id="email" required className="mt-1 block w-full px-4 py-3 bg-background-light dark:bg-background-dark border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-primary focus:border-primary" />
            </div>
            <div>
                ...
                <input type="password" id="password" required className="mt-1 block w-full px-4 py-3 bg-background-light dark:bg-background-dark border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-primary focus:border-primary" />
            </div>
             {!isLogin && (
                 <div>
                    ...
                    <input type="password" id="confirm-password" required className="mt-1 block w-full px-4 py-3 bg-background-light dark:bg-background-dark border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-primary focus:border-primary" />
                </div>
            )}
